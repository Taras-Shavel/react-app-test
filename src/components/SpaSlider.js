...
import itemsData from "../data/spaSlider.json"

function SpaSlider({title, tags}) {
        ...
        <div className="w-full h-[344px] mt-10 box-border overflow-hidden">
            <div className="w-full h-[32px] flex justify-between mb-5">
                ...
                <div className="w-[145px] flex items-center justify-end">
                    ...
                    <img className="w-[24px] h-[24px] cursor-pointer mr-2" src="./buttons/leftButton.png" alt="Left Button" onClick={goToPrev} />
